 ...
 */
public class HalfSangamFragment extends Fragment {
    ...
    String walletAmount;
    int wallet;
    String openAnkValue,closePattiValue,amountVal1;
    String closeAnkValue,openPattiValue,amountVal2;

    EditText openAnk,closeAnk,firstAmountEt;
    EditText closePatti,openPatti,secondAmountEt;

    String game_name,game_timing,game_end_time,type;
    int amount1=0;
    int amount2=0;

    List<String> openAnkList=new ArrayList<>();
    List<String> closeAnkList=new ArrayList<>();
    List<String> openPattiList=new ArrayList<>();
    List<String> closePattiList=new ArrayList<>();
    List<String> amountList1=new ArrayList<>();
    List<String> amountList2=new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dateText=view.findViewById(R.id.half_sangam_date_spinner);
    ...
    private void initializeView(View view){
        totalPoint=view.findViewById(R.id.half_sangam_total_point);

        singleSubmitBtn=view.findViewById(R.id.half_sangam_submit_btn);

        singleSubmitBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                openAnkValue=openAnk.getText().toString();
                closeAnkValue=closeAnk.getText().toString();
                closePattiValue=closePatti.getText().toString();
                openPattiValue=openPatti.getText().toString();
                amountVal1=firstAmountEt.getText().toString();
                amountVal2=secondAmountEt.getText().toString();

                total=Integer.parseInt(amountVal1)+Integer.parseInt(amountVal2);
                ...
                if(!openAnkValue.isEmpty() || !closeAnkValue.isEmpty() || !openPattiValue.isEmpty() || closePattiValue.isEmpty()){
                    submitData(v);
                } else {
    ...
    private void submitNumber(final View view){
        ...
        StringRequest objectRequest = new StringRequest(Request.Method.POST, Constant.half_sangam_game_submit, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                try {

                    JSONObject jsonObject = new JSONObject(response);
                    String sucess=jsonObject.getString("half sangam");
                    if(sucess.isEmpty()){
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("open_ank[]",openAnkList.toArray().toString());
                params.put("close_digit[]",closePattiList.toArray().toString());
                params.put("amount1[]", amountList1.toArray().toString());
                params.put("close_ank[]",closeAnkList.toArray().toString());
                params.put("open_digit[]",openPattiList.toArray().toString());
                params.put("amount2[]", amountList2.toArray().toString());
//                params.put("username",userName);
//                params.put("game_name",game_name);
//                params.put("start_time",game_timing);
//                params.put("end_time",game_end_time);
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    for (int i=0;i<categoryArry.length();i++){
                        ...
                        game_name=data.getString("game_type_name");
                        game_timing=data.getString("open_result_time");
                        game_end_time=data.getString("close_result_time");
...
//                        game_timing=data.getString("game_timing");
//                        game_end_time=data.getString("game_end_time");
//                        String game_result_time=data.getString("game_result_time");
...
//                        type=data.getString("type");
    ...
    private void settingFirstLayout(View view){
        firstLinearLayout=view.findViewById(R.id.dynamic_first_layout);
        firstLinearLayout.setOrientation(LinearLayout.VERTICAL);

        secondLinearLayout=view.findViewById(R.id.dynamic_second_layout);
    ...
    private void addView() {
        ...
        final View layoutView = getLayoutInflater().inflate(R.layout.half_sangam_recycler_design,null,false);

        openAnk=layoutView.findViewById(R.id.first_open_ank_edittext);
        closePatti=layoutView.findViewById(R.id.first_close_patti_edittext);
        firstAmountEt=layoutView.findViewById(R.id.first_amount_val);

        openAnkList.add(openAnk.getText().toString());

        closePattiList.add(closePatti.getText().toString());

        amountList1.add(firstAmountEt.getText().toString());

        FloatingActionButton addFloating=layoutView.findViewById(R.id.dynamic_add_first_floating);
    ...
    private void addViewSecond() {

        final View layoutView = getLayoutInflater().inflate(R.layout.half_sangam_design_second,null,false);

        closeAnk=layoutView.findViewById(R.id.second_close_ank_edittext);
        openPatti=layoutView.findViewById(R.id.second_open_patti_edittext);
        secondAmountEt=layoutView.findViewById(R.id.second_amount_val);

        closeAnkList.add(closeAnk.getText().toString());
        openPattiList.add(openPatti.getText().toString());
        amountList2.add(secondAmountEt.getText().toString());


        FloatingActionButton addFloating=layoutView.findViewById(R.id.dynamic_add_second_floating);
        addFloating.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                addViewSecond();
        ...
        secondLinearLayout.addView(layoutView);

    }

    private void removeViewSecond(View view){
